...
def write_experiment_summary(
    ...
    summary = {
        ...
        "forecast_archive_adequate": future_features.get("forecast_archive_adequate"),
        "forecast_archive_row_count": future_features.get("forecast_archive_row_count"),
        "forecast_archive_station_count": future_features.get("forecast_archive_station_count"),
        "forecast_archive_issue_time_count": future_features.get("forecast_archive_issue_time_count"),
